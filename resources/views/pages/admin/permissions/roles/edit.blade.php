                ...
                <div class="col-12">
                    <div class="card card-primary w-50 mx-auto">
                        <div class="card-header">
                            <h3 class="card-title">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Editar Rol</font>
                                </font>
                            </h3>
                        </div>
                        <!-- /.card-header -->
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="name" name="name" class="form-control" id="name"
                                            placeholder="Ingrese Nombre" value="{{$role->name}}">
                                    </div>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select class="select2 select2-hidden-accessible" multiple=""
                                            ...
                                            tabindex="-1" aria-hidden="true" name="permissions[]">
                                            @foreach ($permissions as $permission)
                                                <option
                                                    @foreach ($role->permissions()->pluck('name') as $name)
                                                        @if (  $name == $permission->name) selected @endif
                                                    @endforeach
                                                >
                                                    {{ $permission->name }}
                                                </option>
