        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header d-flex justify-content-between">
              <h3>Datos de inputs</h3>
              <a href="{{ route('inputs.create') }}" class="btn btn-primary">Crear input</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr role="row" class="odd">
                          ...
                          <td class="d-flex aling-item-center">
                            <a href="{{ route('inputs.edit', $input->slug) }}" class="btn btn-primary mx-1">
                              <i class="nav-icon fas fa-edit"></i>
                            </a>
                            <form action="{{ route('inputs.delete', $input->id) }}" method="post">
                              @csrf
                              @method('DELETE')
