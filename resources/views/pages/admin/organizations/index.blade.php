        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header d-flex justify-content-between">
              <h3>Datos de organizaciones</h3>
              <a href="{{ route('organizations.create') }}" class="btn btn-primary">Crear organización</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr role="row" class="odd">
                          ...
                          <td class="d-flex aling-item-center">
                            <a href="{{ route('organizations.edit', $organization->slug) }}" class="btn btn-primary mx-1">
